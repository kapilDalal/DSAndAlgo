...
* */
public class FormArrayViaConcatenation {
    ...
    public boolean canFormArray(int[] arr, int[][] pieces) {
        ...
        while(i<arr.length){
            if(!map.containsKey(arr[i]))
                ...
                ArrayList<ArrayList<Integer>> arrayLists = map.get(arr[i]);
                boolean found = false;
                int index = i;
                for(List<Integer> l : arrayLists){
                    int size = l.size();
